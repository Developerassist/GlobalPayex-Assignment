...
public class Burger {
    ...
    // Extra additions
    private BillsBurgerChallenge.Addition tomato;
    private BillsBurgerChallenge.Addition lettuce;
    private BillsBurgerChallenge.Addition onion;
    private BillsBurgerChallenge.Addition carrot;
    ...
    public Burger(String name, String bread, String meat, boolean extraAdditions, double price) {
        ...
        this.tomato = new BillsBurgerChallenge.Addition("Tomato", 0.1);
        this.lettuce = new BillsBurgerChallenge.Addition("Lettuce", 0.3);
        this.onion = new BillsBurgerChallenge.Addition("Onion", 0.4);
        this.carrot = new BillsBurgerChallenge.Addition("Carrot", 0.6);
    ...
    public void addIngredient(BillsBurgerChallenge.Addition addition) {
    ...
    public void printAdditionPrice(int number, BillsBurgerChallenge.Addition addition) {
